          ...
          <div className="flex justify-center items-center gap-3 sm:gap-6 md:gap-8 lg:gap-12 flex-wrap">
            {platforms.slice(0, 4).map((platform, index) => {
              ...
              return (
                ...
                >
                  <div className="w-10 h-10 sm:w-16 sm:h-16 md:w-28 md:h-28 lg:w-32 lg:h-32 rounded-full bg-secondary/50 backdrop-blur-sm flex items-center justify-center mb-2 sm:mb-3 group-hover:bg-secondary/70 transition-all duration-300 group-hover:scale-110 border border-border/30">
                    {IconComponent ? (
            ...
            {platforms.slice(4, 8).map((platform, index) => {
              ...
              return (
                <div 
                  ...
                  className="flex flex-col items-center group cursor-pointer"
                >
                  <div className="w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 lg:w-18 lg:h-18 rounded-full bg-secondary/50 backdrop-blur-sm flex items-center justify-center mb-2 sm:mb-3 group-hover:bg-secondary/70 transition-all duration-300 group-hover:scale-110 border border-border/30">
                    {IconComponent ? (
