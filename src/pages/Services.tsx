      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative overflow-hidden mt-8 min-h-[400px] sm:min-h-[500px] md:min-h-[700px] flex items-center justify-center lg:justify-start">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="md:hidden absolute inset-0 bg-gray-900/60" />
          </div>

          {/* Content (Responsive Alignment) */}
          <div className="relative z-10 container mx-auto px-6 flex items-center justify-center lg:justify-start text-center lg:text-left">
